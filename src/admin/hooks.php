...
return [
    ...
    'admin_user_index_view'          => [
        "type"        => 2,//钩子类型(默认为应用钩子;2:应用钩子;3:模板钩子;4:后台模板钩子)
        "name"        => '后台BOSS账号列表界面', // 钩子名称
        "description" => "后台BOSS账号列表界面", //钩子描述
        "once"        => 1 // 是否只执行一次
    ],
    'admin_user_add_view'          => [
        "type"        => 2,//钩子类型(默认为应用钩子;2:应用钩子;3:模板钩子;4:后台模板钩子)
        "name"        => '后台BOSS账号添加界面', // 钩子名称
        "description" => "后台BOSS账号添加界面", //钩子描述
        "once"        => 1 // 是否只执行一次
    ],
    'admin_user_edit_view'          => [
        "type"        => 2,//钩子类型(默认为应用钩子;2:应用钩子;3:模板钩子;4:后台模板钩子)
        "name"        => '后台BOSS账号编辑界面', // 钩子名称
        "description" => "后台BOSS账号编辑界面", //钩子描述
        "once"        => 1 // 是否只执行一次
    ],
