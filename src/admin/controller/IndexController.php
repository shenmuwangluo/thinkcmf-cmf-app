...
class IndexController extends AdminBaseController
{
    ...
    public function index()
    {
        ...
        //显示条数
        $this->assign('gaoDu', config('TABLE_HEIGHT'));#表格高度
        $this->assign('pageSize', config('DATA_LENGTH'));#分页数量
        $this->assign('defaultGaoDu', getDefaultTableHeight('admin'));#表格高度
        $this->assign('defaultPageSize', getDefaultSize('admin'));#分页数量
        //表格高度
        return $this->fetch();
    }

//    /**
//     * 创建时间：2021/5/12 08:10
//     * 获取表格基本配置
//     */
//    public function get_table_config()
//    {
//        $this->success('成功','',[
//            "size"=>getDefaultSize('admin'),
//            "height"=>getDefaultTableHeight('admin'),
//            "size_list"=>config('DATA_LENGTH')
//        ]);
//    }
